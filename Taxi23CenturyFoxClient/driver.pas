...
begin
   ...
   begin
     ...
     frmDriver.Label2.Visible := true;
     frmDriver.Label5.Visible := true;
     frmDriver.Label6.Visible := true;
end;
...
begin
  with AcceptOrderQuery do
    begin
      ...
      Close;
      UpdateSQL.Clear;
      UpdateSQL.Add('update drivers set available = 1 where id = ' +
              IntToStr(driver_id) + ';');
      try
         Open;
         Update;
...
procedure DrawRoute(var path: nodesMass; routeColor: string);
var
   i: integer;
begin
...
procedure TfrmDriver.FormShow(Sender: TObject);
  begin
     ...
     frmDriver.Label2.Visible := false;
     frmDriver.Label5.Visible := false;
     frmDriver.Label6.Visible := false;
  end;
